...
namespace Sintra.Application.Features.Products.Queries.GetProductById
{
    public class GetProductByIdQuery : IRequest<Response<Product>>
    {
        ...
        public class GetProductByIdQueryHandler : IRequestHandler<GetProductByIdQuery, Response<Product>>
        {
            ...
            {
                var product = await _productRepository.GetProductById(query.Id, p=>p.ProductCategories);
