...
namespace Sintra.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20211006065826_MakeWorkerIdOfRecipeNullable")]
    partial class MakeWorkerIdOfRecipeNullable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.CategoryAccessory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.EmployeeBalanceTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EmployeeBalanceTransactions");
                });

            modelBuilder.Entity("Sintra.Domain.Entities.EmployeeBonusTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("PayerEmployeeId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("PayerEmployeeId");

                    b.ToTable("EmployeeBonusTransactions");
                });

            modelBuilder.Entity("Sintra.Domain.Entities.EmployeeCreditBalanceTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EmployeeCreditBalanceTransactions");
                });
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.OrderBonus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.Receipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.ApplicationUser", b =>
                {
                    b.HasOne("Sintra.Domain.Entities.RefreshToken", "RefreshToken")
                        .WithMany()
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.EmployeeBalanceTransaction", b =>
                {
                    ...
                    b.HasOne("Sintra.Domain.Entities.ApplicationUser", "RecieverEmployee")
                        .WithMany()
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.EmployeeBonusTransaction", b =>
                {
                    ...
                    b.HasOne("Sintra.Domain.Entities.ApplicationUser", "PayerEmployee")
                        .WithMany()
                        .HasForeignKey("PayerEmployeeId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.Receipe", b =>
                {
                    ...
                    b.HasOne("Sintra.Domain.Entities.ApplicationUser", "Worker")
                        .WithMany()
