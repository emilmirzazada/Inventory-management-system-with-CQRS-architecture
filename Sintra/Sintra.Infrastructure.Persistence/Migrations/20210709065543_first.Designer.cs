...
namespace Sintra.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20210709065543_first")]
    partial class first
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.CreditCallStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.ExpirationCallStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ExpirationCallStatuses");
                });
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.NotificationStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.NotificationType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.NotificationUserStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.ProductType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.TransferStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.CreditCall", b =>
                {
                    ...
                    b.HasOne("Sintra.Domain.Entities.CreditCallStatus", "Status")
                        .WithMany()
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.ExpirationCall", b =>
                {
                    ...
                    b.HasOne("Sintra.Domain.Entities.ExpirationCallStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.Notification", b =>
                {
                    b.HasOne("Sintra.Domain.Entities.NotificationStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Sintra.Domain.Entities.NotificationType", "Type")
                        .WithMany()
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.NotificationUser", b =>
                {
                    ...
                    b.HasOne("Sintra.Domain.Entities.NotificationUserStatus", "Status")
                        .WithMany()
                        .HasForeignKey("StatusId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.Product", b =>
                {
                    b.HasOne("Sintra.Domain.Entities.ProductType", "ProductType")
                        .WithMany()
            ...
            modelBuilder.Entity("Sintra.Domain.Entities.ProductTransfer", b =>
                {
                    ...
                    b.HasOne("Sintra.Domain.Entities.TransferStatus", "TransferStatus")
                        .WithMany()
